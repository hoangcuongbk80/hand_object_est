...
parser.add_argument('--model', default='handpose', help='Model file name [default: handpose]')
...
parser.add_argument('--num_target', type=int, default=256, help='Proposal/hand number [default: 256]')
...
from handpose_dataset import handposeDataset
from model_util import datasetConfig
DATASET_CONFIG = datasetConfig()
TRAIN_DATASET = handposeDataset('train', num_points=NUM_POINT, augment=False,
